...
//4.BillParticipant
const testBillParticipant = async () => {
    try {
        const newBillParticipant = await BillParticipant.create({
            bill_id: '64f1b9a5349f2b0012345680',
            participant_id: '64f1b9a5349f2b0012345681',
            amount: 50,
        });
        console.log('BillParticipant created:', newBillParticipant);
    } catch (err) {
        console.error('Error creating bill participant:', err.message);
    }
};
...
//     await BillParticipant.deleteMany({});
